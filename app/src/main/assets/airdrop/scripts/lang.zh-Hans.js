...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要上传到 Airdrop 的 APK 文件';
STRINGS.SUPPORTED_FILE_TYPES = '';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接 Airdrop 服务器，请重新打开 Airdrop 服务并刷新此页面';
...
STRINGS.FONT_UNSUPPORTED_FILE_TYPE = '请选择您要上传的 TTF 或 OTF 字体文件。';
STRINGS.FONT_SUPPORTED_FILE_TYPES = '支持 TTF 和 OTF';
STRINGS.FONT_VALID_CHOSEN_FILE_COUNT = '个文件。\n请选择 TTF 或 OTF 文件，文件名不能重复。';
